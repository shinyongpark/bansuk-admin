...
const CustomerSupport = () => {
    ...
    useEffect(() => {
        if (selectedRow) {
            ...
            const fetchConsultations = async () => {
                const response = await axios.post('https://bs-admin.com:443/customer-support/search-consultations', selectedRow, {
    ...
    const handleCheckboxChangeASTable = async (row) => {
        ...
        if (foundSelected) {
            ...
            console.log(row);
            const response = await axios.post('https://bs-admin.com:443/customer-support/search-ASTable/consultations', row, {
                headers: { 'Content-Type': 'application/json' },
            });
    ...
    const handleASTableConfirm = async () => {
        ...
        try {
            const response = await axios.post('https://bs-admin.com:443/customer-support/search-ASTable/resolved', selectedRowResASTable, {
                headers: { 'Content-Type': 'application/json' },
        ...
        try {
            ...
            if (!productDetails.orderCount || !Number(productDetails.orderCount) || productDetails.orderCount === 0) {
                ...
                if (!parsedStockGood) { //call only once if needed
                    const getstockGood = await axios.get('https://bs-admin.com:443/get-stock-good');
                    parsedStockGood = transformData_stock(getstockGood)
                    setStockGood(parsedStockGood);
                }

                //get orderid
                const getstockGood = await axios.get('https://bs-admin.com:443/get-next-orderid');
                ...
                const checkDuplicate = await axios.post('https://bs-admin.com:443/customer-support/check-duplicates',
                    {
    ...
    const submitOrderCheck = async () => {
        try {
            ...
            const insertOrder = await axios.post('https://bs-admin.com:443/customer-support/submitOrderCheck-external-stock',
                {
                    orderData: orderData,
                    stockData: stockData,
    ...
    const handleView = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('https://bs-admin.com:443/customer-support/search', productDetails, {
                headers: { 'Content-Type': 'application/json' },
            });
            const transformedData = transformData_external(response)
    ...
    const handleConsulation = async () => {
        ...
        try {
            const response = await axios.post('https://bs-admin.com:443/customer-support/submit-consultations', newConsultations, {
                headers: { 'Content-Type': 'application/json' },
                withCredentials: true
            });
            //update consultations in page 4
            const response_search = await axios.post('https://bs-admin.com:443/customer-support/search-consultations', selectedRow, {
                headers: { 'Content-Type': 'application/json' },
            });
    ...
    const handleSelectedRowConsult = async (selectedRowConsult) => {
        ...
        try {
            ...
            const response = await axios.post('https://bs-admin.com:443/customer-support/edit-consultations', newConsultations, {
                headers: { 'Content-Type': 'application/json' },
                withCredentials: true
            });
            //update consultations in page 4
